...
public class CartServiceImpl implements CartService {
    ...
    public CartPojo addCart(CartPojo cart) throws ApplicationException {
        CartEntity cartEntity = new CartEntity(cart.getCartId(), cart.getUserId(), cart.getCartTotal(), cart.isCartPaid(), cart.isCartRemoved());
        CartEntity returnCart = cartRepository.saveAndFlush(cartEntity);
